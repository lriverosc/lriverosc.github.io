...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      // Static export has no server to send this to — fall back to opening
      // the visitor's mail client, same as the rest of the site's contact UI.
      const subject = encodeURIComponent(`Contacto desde ${fullName}`);
